...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"uni-jianKang","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!*****************************************!*\
  !*** D:/WEB/XM/uni-jianKang/pages.json ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 25 */
/*!********************************************!*\
  !*** D:/WEB/XM/uni-jianKang/utile/http.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uniCloud, uni) {// ---------------amusing

// 查询活动
var getAmusingActivity = function getAmusingActivity(e) {
  return uniCloud.
  callFunction({
...
// ---------------my
// 查询用户
var getMyUsers = function getMyUsers(e) {
  return uniCloud.
  callFunction({
    name: 'get-my-users' });
...
// 查询充值记录
var getRechargeRecord = function getRechargeRecord(e) {
  return uniCloud.
  callFunction({
...
// 添加充值记录
var addRecord = function addRecord(e) {
  return uniCloud.
  callFunction({
    name: 'record',
    data: {
...
// 查询订单号
var getOrderID = function getOrderID(e) {
  return uniCloud.
  callFunction({
    name: 'get-order-id' });
...
// 修改订单号
var updateOrderId = function updateOrderId(e) {
  return uniCloud.
  callFunction({
...
module.exports = {
  getAmusingActivity: getAmusingActivity,
...
/* 30 */
/*!*********************************************************!*\
  !*** D:/WEB/XM/uni-jianKang/pages.json?{"type":"stat"} ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__0457FB0" };exports.default = _default;
